...
function RenderUserButtons()
	...
	for id, data in pairs(NAUserButtons) do
		...
		btn.BackgroundColor3 = Color3.fromRGB(0, 0, 139)
...
cmd.add({"updatelog","updlog","updates"},{"updatelog (updlog,updates)","show the update logs for Voidy Admin"},function()
	gui.updateLogs()
end)
...
cmd.add({"functionspy"},{"functionspy","Check console"},function()
	...
	example.Text=""
	example.TextColor3=Color3.fromRGB(0, 0, 139)
...
cmd.add({"toolview2", "tview2"}, {"toolview2 (tview2)", "Live-updating tool viewer"}, function()
	...
	minimizeBtn.Parent = topbar
	InstanceNew("UICorner", minimizeBtn)
...
cmd.add({"hug", "clickhug"}, {"hug (clickhug)", "huggies time (click on a target to hug)"}, function()
	if IsR6() then
		...
		toggleHugButton.BackgroundColor3 = Color3.fromRGB(0, 0, 139)
		...
		sideToggleButton.BackgroundColor3 = Color3.fromRGB(0, 0, 139)
